# Support for Output Descriptors in ApexGenesiscoin Core

Since ApexGenesiscoin Core v0.17, there is support for Output Descriptors. This is a
...
on ApexGenesiscoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing ApexGenesiscoin Core wallets, a convenience function `combo` is
