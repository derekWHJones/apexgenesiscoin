...
### Build and sign ApexGenesiscoin Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --num-make 2 --memory 3000 --commit apexgenesiscoin=v${VERSION} ../apexgenesiscoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit apexgenesiscoin=v${VERSION} ../apexgenesiscoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --num-make 2 --memory 3000 --commit apexgenesiscoin=v${VERSION} ../apexgenesiscoin/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`apexgenesiscoin-${VERSION}-osx-unsigned.dmg`, `apexgenesiscoin-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import apexgenesiscoin/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer apexgenesiscoin-osx-unsigned.tar.gz to osx for signing
...
space *do not upload these to the apexgenesiscoin.org server, nor put them in the torrent*.
...
- Announce the release:
  ...
  - apexgenesiscoin-dev and apexgenesiscoin-dev mailing list
