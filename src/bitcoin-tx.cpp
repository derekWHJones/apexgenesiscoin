...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " apexgenesiscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  apexgenesiscoin-tx [options] <hex-tx> [commands]  Update hex-encoded apexgenesiscoin transaction\n" +
            "or:     apexgenesiscoin-tx [options] -create [commands]   Create hex-encoded apexgenesiscoin transaction\n" +
            "\n";
