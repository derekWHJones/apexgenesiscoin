...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s apexgenesiscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  apexgenesiscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded apexgenesiscoin transaction") + "\n" +
              "  apexgenesiscoin-tx [options] -create [commands]   " + _("Create hex-encoded apexgenesiscoin transaction") + "\n" +
              "\n";
