...
"""Verify that starting apexgenesiscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start apexgenesiscoin with -h for help text")
        ...
        self.log.info("Start apexgenesiscoin with -version for version information")
        ...
        self.log.info("Start apexgenesiscoind with -fakearg to make sure it does not start")
